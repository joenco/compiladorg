...
def ejecute(self, textbuffer, textbuffer1, sw1, statusbar, context_id, vistas, opcion):
        textbuffer = textbuffer
        ...
        result(self, textbuffer1)
        result2(self, textbuffer1)

        if opcion==1:
          errosview(self, textbuffer1, sw1, statusbar, context_id, vistas, 1)
        elif opcion==2:
          errosview(self, textbuffer1, sw1, statusbar, context_id, vistas, 2)

def errosview(self, textbuffer, sw, statusbar, context_id, vistas, opcion):
        textbuffer = textbuffer
        sw = sw
        statusbar = statusbar
        context_id = context_id
