...
t_Atributo = r'((origen)|(escala)|(centro)|(altura)|(radio)|(x)|(y)|(A)|(B)|(C)|(D)|(borde)|(fondo))[\s]'
...
t_Color = r'(([rR]ojo)|([aA]zul)|([aA]marillo)|([vV]erde)|([mM]orado)|([gG]ris)|([nN]egro)|([nN]aranja)|([mM]arron)|([rR]osado))[\s]'
t_Inicio = r'INICIAR'
t_Fin = r'FINALIZAR'
